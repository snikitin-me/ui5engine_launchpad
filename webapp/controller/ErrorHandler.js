...
sap.ui.define(['sap/ui/base/Object', 'sap/m/MessageBox'], function(
  ...
  return BaseObject.extend('controller.ErrorHandler', {
    /**
    ...
    _showMetadataError: function(sDetails) {
      MessageBox.show(this._oResourceBundle.getText('errorMetadataText'), {
    ...
    _showServiceError: function(sDetails) {
      ...
      MessageBox.show(this._oResourceBundle.getText('errorServiceText'), {
